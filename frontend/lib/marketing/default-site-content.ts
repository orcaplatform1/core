...
export const DEFAULT_SITE_CONTENT: SiteContentSettings = {
  ...
  toolsItems: [
    {
      icon: "bitcoin",
      title: "Kripto Araçları",
      description: "Canlı fiyatlar, heatmap ve Fear & Greed endeksini tek ekranda takip et.",
      href: "/tools/crypto",
      previewKey: "crypto",
    },
    {
      icon: "landmark",
      title: "Forex & BIST100",
      description: "Döviz, altın ve BIST100 verileriyle piyasanın tamamını gör.",
      href: "/tools/forex",
      previewKey: "forex",
    },
    {
      ...
      description: "Önemli ve Kritik verilerin piyasaya etkilerini takip et.",
      href: "/programs",
      previewKey: "calendar",
    },
    {
    ...
    {
      icon: "waypoints",
      title: "İleri Simülasyon Programı",
      description: "Gerçek piyasa koşullarında sanal para ile risk almadan ticaret yap, performansını raporla.",
      href: "/simulation",
    ...
    },
    {
      icon: "waves",
      title: "Balina Takibi",
      description: "Büyük cüzdan hareketlerini anlık izle, piyasanın nabzını yakala.",
      href: "/tools/crypto/whales",
      previewKey: "whales",
    },
  ],
