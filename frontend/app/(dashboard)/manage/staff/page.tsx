    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-[#A8A6A0]">AVM personel bazlı test/satış/komisyon özeti.</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="rounded-2xl border border-border bg-card p-4">
          <p className="text-xs text-[#A8A6A0]">Toplam Test</p>
          <p className="mt-1 text-xl font-semibold text-[#F5F1EA]">{totals.testsGiven}</p>
        </div>
        <div className="rounded-2xl border border-border bg-card p-4">
          <p className="text-xs text-[#A8A6A0]">Dönüşüm</p>
        ...
        <div className="rounded-2xl border border-border bg-card p-4">
          <p className="text-xs text-[#A8A6A0]">Toplam Komisyon</p>
