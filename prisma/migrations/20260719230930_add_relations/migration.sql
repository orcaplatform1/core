...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_referredByStaffId_fkey" FOREIGN KEY ("referredByStaffId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
